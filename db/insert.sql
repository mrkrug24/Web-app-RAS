...
(3, 'Елена', 'Александровна', 'Смирнова', 'Кутузовский проспект', 20, 12, 2, NULL),
(4, 'Иван', 'Дмитриевич', 'Козлов', 'Проспект Вернадского', 30, 7, 2, 200000),
(5, 'Мария', 'Ивановна', 'Федорова', 'Тверская улица', 40, 3, 3, 100000),
(6, 'Алексей', 'Павлович', 'Соколов', 'Пресненская набережная', 15, 9, 4, NULL),
...
(10, 'Андрей', 'Владимирович', 'Ковалев', 'Ленинградский проспект', 18, 30, 7, NULL);
